<template>
	<div class="login">
		<div class="main">
			<nav class="loginbox">
				<div class="logo">
				  	<router-link to="/" class="router-link-active"><img v-lazy="agentLogo"></router-link>
				</div>
				<div class="form">
					...
					<div class="row input-row changebtn">
				    	...
				    	<label class="btn-def"><img width="100%" :src="checkImg"></label>
...
export default{
	...
	methods:{
		...
		login(){
			...
			}else if(this.captchaValue == null){
				this.$popup({
					hint:'请输入验证码',
					hintShow:true
				})

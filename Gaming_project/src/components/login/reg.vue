	...
	<div class="reg">
		...
		<div class="main">
			<div class="loginbox regbox">
			  	<div class="logo"><router-link to="/" class="router-link-active"><img src="~@/assets/images/logo.svg"></router-link></div>
			  	<div class="form">
				    ...
				    <div class="row input-row">
				    	...
				    	<label class="btn btn-def" style="padding: 0px 5px; line-height: 30px;">发送验证码</label>
				    </div>
				    <div class="row input-row">
				    	<span><i class="iconfont bz-yanzhengma">&#xe60d;</i></span> 
				    	<input type="text" placeholder="短信验证码" maxlength="6" @focus="focusFun" @blur="blurFun">
				    </div>
				    <div class="row input-row">
				    ...
				    <div class="row ckbox">
				    	<span>
				        	注册即代表您已同意 <router-link to="#/UC/Reg/Rules" class="">用户注册协议</router-link>
				    	</span> 

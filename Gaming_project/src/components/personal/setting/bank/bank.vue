		...
		<div class="main">
			<div class="bankbox">
				...
				<div class="row btnbox">
					<router-link tag="a" to="/personal/setting/bank" class="btn btn-danger" @click.native="bindingBank">
						确定
					</router-link>
				</div>
			</div>
				...
				<div class="bottombox">
					...
					<div class="allbank">
						<div class="cont banks" @click="allbanks=false;openBank=item.name" v-for='item in baseBankList'>
							<span class="retinabb">
								<span class="bankicon gsyh"><img width="100%" :src="'static/img/'+item.bid+'.png'" :alt="item.name"></span>{{item.name}}
							</span>
						</div>
					</div>
				</div>

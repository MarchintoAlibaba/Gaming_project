	...
	<div class="setting">
		<div class="main">
			<div class="item">
				...
				<router-link tag="a" to="/personal/setting/phone" class="row">
					<span>
						手机
					</span>
					<span>
						<i class="iconfont">{{userinfo.userID}}&ensp;&#xe657;</i>
					</span>
				</router-link>
			</div>
			<div class="item">
				<router-link tag="a" to="/personal/setting/bank" class="row">
					<span>
						设置提款卡
					</span>
					<span>
						<i v-if="!userinfo.isBankValided" class="iconfont icon-warn">&#xe604;</i>
						<i v-if="userinfo.isBankValided" class="iconfont bz-zhengque">&#xe69e;</i>
						{{isBankValidedW}}
						&ensp;<i class="iconfont">&#xe657;</i>
					</span>
				</router-link>
				<router-link tag="a" to="/personal/setting/pwd" class="row">
					<span>
						修改密码
					</span>
					<span>
			...
			<div class="item">
				<router-link tag="a" to="/" class="row" @click.native="loginout">
					<span>
						退出
					</span>
					<span>
...
export default{
	...
	mounted(){
		this.isBankValidedW = this.userinfo.isBankValided ? '未设置' : '已设置';
		// this.enter()
	},
	methods:{
		loginout(){
